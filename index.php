	...
	<div class="row">
		...
		<div class="col-sm-4 col-md-4" style="margin-bottom: 20px">
			<div class="post">
				...
				<div class="content">
					<div class="author">
						بواسطة <a href="#"><b>Galal</b></a> |
						بتاريخ <time datetime="2014-01-20">25-8-2019</time>
					</div>
					...
					<hr />
					<div class="text-left">
						<a href="#" class="btn btn-primary btn-sm">اقرأ المزيد &larr;</a>
					</div>
				</div>
			</div>
		</div>
